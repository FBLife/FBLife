...
-(void)fasong:(UIBarButtonItem *)sender
{
    ...
    backView.frame = CGRectMake(0,(iPhone5?(568-IOS_VERSION>=7.0?0:20):(480-IOS_VERSION>=7.0?0:20))-73,320,73);
...
-(void)face:(UIButton *)button
{
    ...
    if (isFace)
    {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            backView.frame = CGRectMake(0,(iPhone5?568:480)-(IOS_VERSION >= 7.0?0:20)-73-215,320,73);
