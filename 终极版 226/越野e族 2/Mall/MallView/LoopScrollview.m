...
- (id)initWithFrame:(CGRect)frame delegate:(id<LoopScrollviewDelegate>)delegate focusImageItems:(SGFocusImageItem *)firstItem, ...
{
...
- (void)setupViews
{
    ...
    _pageControl = [[SMPageControl alloc]initWithFrame:CGRectMake(0,self.frame.size.height - 37/2,320,10)];
