   ...
   // self.type=__type;
    ...
    if (__type==0) {
        ...
        for (int i=0; i<NUMBEROFBUTTON; i++) {
            ...
            UIImageView *imgv=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"车系图片列表-竖线.png"]];
    ...
    if (__type==1)
    {
        ...
        for (int i=0; i<NUMBEROFBUTTON; i++)
        {
            ...
            icon_view.image = [UIImage imageNamed:@"未选中三角.png"];
    ...
    if (mytype==1)
    {
        if (sender.tag -10000000 == selectindex1)
        {
            ...
            }else
            {
                ...
                imageView2.image = [UIImage imageNamed:@"未选中三角.png"];
